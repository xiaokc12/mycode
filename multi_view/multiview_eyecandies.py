...
def get_mv_images(ply_path, gt_path, point_size = 8, view_save_path = "./mutil_views", gt_save_path = "./mutil_views",cor_save_path = './mutil_views', file_id= "00"):
    ...
    o3d_pc_gt.transform(matrix_x(0.25*np.pi))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="./data/Eyecandies_processed", help="path to test dataset")
    ...
    cls_list= ["Confetto", "LicoriceSandwich", "PeppermintCandy"]
    for cls in cls_list:
        base_directory = f"{args.data_path}/{cls}"
        point_size = 10
        for folder in ["test_public"]:
